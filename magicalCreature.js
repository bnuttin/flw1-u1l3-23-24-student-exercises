...
let visitorAgeDecimal = 60 * Math.random();
let visitorAge = Math.round(visitorAgeDecimal);
...
let zooSummary = "Bob can visit " + creatureName  + "(" + creatureDescription + "), which is friendly (" + isFriendly + "):" + canVisit
